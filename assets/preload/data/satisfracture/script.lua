...
function onCreate()
	...
	if isStoryMode and cacheStory then
		...
		--	makeLuaSprite('vortex', 'wrath/Vortex', 0, 0)
		--end
		makeLuaSprite('aaa', 'characters/WrathRetroSpecter_2', 0, 0)
		makeLuaSprite('bbb', 'wrath/flames_colorchange', 0, 0)
		makeLuaSprite('vortex', 'wrath/Vortex', 0, 0)
	end
end
