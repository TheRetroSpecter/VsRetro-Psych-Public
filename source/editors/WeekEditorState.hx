...
class WeekEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		var bgYellow = new FlxSpriteExtra(0, 56).makeSolid(FlxG.width, 386, 0xFFF9CF51);
		...
		var blackBarThingie = new FlxSpriteExtra().makeSolid(FlxG.width, 56, FlxColor.BLACK);
		add(blackBarThingie);
	...
	function addWeekUI() {
		...
		backgroundInputText = new FlxUIInputText(10, songsInputText.y + 40 + 40, 120, '', 8);
		...
		tab_group.add(new FlxText(songsInputText.x, songsInputText.y + 40 - 18, 0, 'Characters:'));
