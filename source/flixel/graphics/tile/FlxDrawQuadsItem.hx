...
class FlxDrawQuadsItem extends FlxDrawBaseItem<FlxDrawQuadsItem> {
	...
	override public function render(camera:FlxCamera):Void {
		...
		if((shader is AmongUsColorSwapShader) && aucs != null) {
			var shader:AmongUsColorSwapShader = cast shader;

			shader.uApply.value = aucs.uApply;
			shader.uRed.value = aucs.uRed;
			shader.uBlue.value = aucs.uBlue;
			shader.uGreen.value = aucs.uGreen;
			shader.uHsv.value = aucs.uHsv;
		}
