...
class AssetCache implements IAssetCache
{
	...
	**/
	...
	/**
		Retrieves the BitmapData cache.

		@return	The BitmapData cache
	**/
	public inline function getBitmapDataCache():Map<String, BitmapData>
	{
		return bitmapData;
	}

	/**
		Retrieves the Font cache.

		@return	The Font cache
	**/
	public inline function getFontCache():Map<String, Font>
	{
		return font;
	}

	/**
		Retrieves the Sound cache.

		@return	The Sound cache
	**/
	public inline function getSoundCache():Map<String, Sound>
	{
		return sound;
	}
	...
	**/
	public inline function getBitmapData(id:String):BitmapData
	{
	...
	**/
	public inline function hasBitmapData(id:String):Bool
	{
	...
	/**
		...
		@return	Whether the object has been cached
	**/
	public inline function hasFont(id:String):Bool
	{
	...
	/**
		...
		@return	Whether the object has been cached
	**/
	public inline function hasSound(id:String):Bool
	{
	...
	**/
	public inline function removeBitmapData(id:String):Bool
	{
		#if lime
	...
	/**
		...
		@return	`true` if the asset was removed, `false` if it was not in the cache
	**/
	public inline function removeFont(id:String):Bool
	{
		#if lime
	...
	/**
		...
		@return	`true` if the asset was removed, `false` if it was not in the cache
	**/
	public inline function removeSound(id:String):Bool
	{
		#if lime
	...
	**/
	public inline function setBitmapData(id:String, bitmapData:BitmapData):Void
	{
	...
	**/
	public inline function setFont(id:String, font:Font):Void
	{
	...
	**/
	public inline function setSound(id:String, sound:Sound):Void
	{
		this.sound.set(id, sound);
	}

	// Get & Set Methods
	@:noCompletion private #if !openfljs inline #end function get_enabled():Bool
	{
		return __enabled;
	}

	@:noCompletion private #if !openfljs inline #end function set_enabled(value:Bool):Bool
	{
